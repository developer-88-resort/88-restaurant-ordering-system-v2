                        ...
                        <tr>
                            <td style="padding:16px 32px 32px 32px; color:#4B4136; font-size:14px; line-height:1.6;">
                                ...
                                <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 auto 24px auto;">
                                    <tr>
                                        <td align="center" style="border-radius:10px; background-color:#8A3330;">
                                            <a href="{{ $url }}" target="_blank" style="display:inline-block; padding:12px 28px; font-size:14px; font-weight:bold; color:#ffffff; text-decoration:none;">{{ __('Accept Invitation') }}</a>
                                        </td>
                                    </tr>
                                </table>

                                <p style="margin:0 0 16px 0;">{{ __('This invitation link will expire in :days days.', ['days' => 7]) }}</p>
                                ...
                                <p style="margin:0; font-size:12px; color:#8A7B6D;">
                                    {{ __('If you\'re having trouble clicking the ":button" button, copy and paste the URL below into your web browser:', ['button' => __('Accept Invitation')]) }}
                                    <br>
